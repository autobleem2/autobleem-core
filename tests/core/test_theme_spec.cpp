...
ThemeSpec fullSpec() {
    ...
    s.classic.menuPanel.x = 30; s.classic.menuPanel.y = 10; s.classic.menuPanel.w = 1220; s.classic.menuPanel.h = 530;
    s.classic.menuPanel.color = ThemeColor(0, 0, 0);
    s.classic.menuPanel.alpha = 170;
    s.classic.statusBar.set = true;
    s.classic.statusBar.x = 0; s.classic.statusBar.y = -670; s.classic.statusBar.w = 1280; s.classic.statusBar.h = 30;
    ...
    s.classic.freeSpaceText.x = 180; s.classic.freeSpaceText.y = 35;
    s.classic.editorCover.set = true;
    s.classic.editorCover.x = 95; s.classic.editorCover.y = 130;
    auto &b = s.classic.buttons;
    b.cross = "cross.png"; b.circle = "circle.png"; b.square = "square.png"; b.triangle = "triangle.png";
    b.start = "start.png"; b.select = "select.png"; b.l1 = "l1.png"; b.r1 = "r1.png"; b.l2 = "l2.png"; b.r2 = "r2.png";
    b.check = "on.png"; b.uncheck = "off.png"; b.esc = "esc.png"; b.enter = "enter.png"; b.tab = "tab.png";
    ...
    l.menuIcons.memcard = "images/menu_memcard.png"; l.menuIcons.resume = "images/menu_resume.png";
    l.memcardManager.grid = "images/memcard_grid.png"; l.memcardManager.pencil = "images/memcard_pencil.png";
    ...
    l.snapPanel.x = 260; l.snapPanel.y = 225; l.snapPanel.w = 240; l.snapPanel.h = 180; l.snapPanel.set = true;
...
TEST_CASE("a key of the wrong type is ignored, not an error") {
    ...
    tmp.writeFile("theme.json",
                  "{ \"classic\": { \"background\": 7, \"menuLines\": \"twelve\", \"textColor\": \"red\","
