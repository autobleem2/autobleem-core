...
// converts all, or the first nchars, of the passed string to lower case. a reference to the modified string is
// returned.
...
// converts all, or the first nchars, of the passed string to upper case. a reference to the modified string is
// returned.
