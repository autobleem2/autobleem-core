...
Each extension is a folder of its own, unpacked here by hand:
...
switches it on or off. An extension is installed and updated by hand only - nothing,
not even the Store, installs one for you.
)";
}
